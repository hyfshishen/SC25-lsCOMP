...
int main(int argc, char* argv[])
{
    ...
    for(int i=0; i<3; i++) cuLSZ_compression_uint16_bsize64(d_oriData, d_cmpBytes, &cmpSize, dims, quantBins, poolingTH, stream);
    printf("GPU warmup finished!\n\n");

    // cuLSZ compression.
    timer_GPU.StartCounter();
    cuLSZ_compression_uint16_bsize64(d_oriData, d_cmpBytes, &cmpSize, dims, quantBins, poolingTH, stream);
    ...
    // cuLSZ decompression.
    timer_GPU.StartCounter();
    cuLSZ_decompression_uint16_bsize64(d_decData, d_cmpBytes, cmpSize, dims, quantBins, poolingTH, stream);
